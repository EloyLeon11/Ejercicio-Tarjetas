...
// 3. Indicar en HTML cuántas personas tienen la fecha de expiración en este año para la tarjeta de crédito
...
const expirationCount = document.createElement("p");
expirationCount.textContent = `fecha de expiración ${year}: ${countExpired}`;
root.appendChild(expirationCount);
